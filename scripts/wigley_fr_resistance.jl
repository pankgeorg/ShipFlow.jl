...
const S_wet = wigley_volume(L_c, B_c, T_c) / T_c  # crude — V/T ≈ planform area
...
results = []
csv = open(joinpath(abspath(@__DIR__), "..", "runs", "wigley_fr_resistance.csv"), "w")
...
# Plot
OUTDIR = abspath(joinpath(@__DIR__, "..", "runs", "wigley_fr_resistance"))
mkpath(OUTDIR)
